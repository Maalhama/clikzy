...
export function LobbyGamificationBar() {
  ...
  return (
    <div className="mx-auto mb-5 max-w-7xl px-4 md:px-6">
      <div className="flex items-center gap-2.5 overflow-x-auto panel p-2.5 backdrop-blur-md scrollbar-hide">
        ...
        {/* Classement */}
        <Link href="/classement" className="flex shrink-0 items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-sm font-semibold text-white/70 transition-colors hover:bg-white/10 hover:text-white">
        ...
        {/* Quêtes à récupérer */}
        {claimable > 0 && (
          <Link href="/profile" className="ml-auto flex shrink-0 items-center gap-1 rounded-full border border-green-400/30 bg-green-400/10 px-3 py-1.5 text-xs font-bold text-green-300">
