...
// Mapping of exact product names from database to SVG files
const PRODUCT_SVG_MAP: Record<string, string> = {
  // ============ SMARTPHONES ============
  'iphone 15 pro max': '/products/iphone-15-pro.svg',
  'iphone 15 pro': '/products/iphone-15-pro.svg',
  'iphone 15': '/products/iphone-15-pro.svg',
  'iphone 16 pro max': '/products/iphone-15-pro.svg',
  'iphone 16 pro': '/products/iphone-15-pro.svg',
  'iphone': '/products/iphone-15-pro.svg',
  'samsung galaxy s24 ultra': '/products/samsung-galaxy.svg',
  'samsung galaxy z fold 5': '/products/samsung-galaxy.svg',
  ...
  'nintendo switch oled': '/products/nintendo-switch.svg',
  ...
  'meta quest 3': '/products/meta-quest.svg',
  ...
  // ============ AUDIO ============
  'airpods pro 2': '/products/airpods-pro.svg',
  ...
  'sony wh-1000xm4': '/products/sony-headphones.svg',
  ...
  'vanmoof s5': '/products/electric-bike.svg',
  'vanmoof': '/products/electric-bike.svg',
  'cowboy 4': '/products/electric-bike.svg',
  ...
  // ============ ELECTROMENAGER PREMIUM ============
  'dyson v15 detect': '/products/dyson-vacuum.svg',
  'dyson v15': '/products/dyson-vacuum.svg',
  'dyson v12': '/products/dyson-vacuum.svg',
  'dyson v11': '/products/dyson-vacuum.svg',
  'dyson v10': '/products/dyson-vacuum.svg',
  'aspirateur dyson': '/products/dyson-vacuum.svg',
  'aspirateur': '/products/dyson-vacuum.svg',
  'thermomix tm6': '/products/thermomix.svg',
  'thermomix': '/products/thermomix.svg',
  'dyson airwrap complete': '/products/dyson-airwrap.svg',
