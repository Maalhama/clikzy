      ...
      <AnimatePresence mode="popLayout">
        {notifications.map(({ badge, id }) => {
          ...
          return (
            ...
            >
              <div
                className={`relative overflow-hidden rounded-2xl border-2 ${colors.border} ${colors.bg} ${colors.glow} backdrop-blur-xl p-4 w-[calc(100vw-2rem)] max-w-[380px] sm:w-auto sm:min-w-[320px]`}
              >
