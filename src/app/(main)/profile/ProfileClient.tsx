    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 py-6">
        ...
        >
          ...
          {/* Cleekzy Wrapped — bilan partageable */}
          {profile.username && (
            <Link
              href={`/wrapped/${encodeURIComponent(profile.username)}`}
              className="group flex items-center justify-center gap-2 border-t border-white/10 py-3 text-sm font-semibold text-neon-pink transition-colors hover:bg-neon-pink/[0.06]"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              Voir mon Cleekzy Wrapped
