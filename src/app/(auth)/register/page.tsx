...
export default function RegisterPage() {
    ...
    return (
      <div className="min-h-dvh w-full flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="text-center max-w-sm relative z-10">
          ...
          <h1 className="text-2xl font-bold text-white mb-3">Compte cree !</h1>
  ...
  return (
    <div className="min-h-dvh w-full flex flex-col lg:flex-row relative overflow-y-auto" style={{ paddingBottom: 'max(5rem, env(safe-area-inset-bottom))' }}>
      ...
      {/* Right Panel - Form */}
      <div className="flex-1 flex items-center justify-center px-6 py-8 pb-24 lg:p-10 relative z-10">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center lg:text-left mb-6">
            <h2 className="text-2xl font-bold text-white mb-2">Creer un compte</h2>
