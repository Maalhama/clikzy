...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-dvh w-full flex flex-col lg:flex-row relative overflow-y-auto" style={{ paddingBottom: 'max(5rem, env(safe-area-inset-bottom))' }}>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-text-secondary">À l&apos;inscription, sans engagement</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
      ...
      {/* Right Panel - Form */}
      <div className="flex-1 flex items-start lg:items-center justify-center px-6 pt-6 pb-52 lg:p-10 relative z-10">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {error && (
              <div role="alert" className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-danger/10 border border-danger/20 text-danger text-sm">
          ...
          {/* Security badge - hidden on mobile to save space */}
