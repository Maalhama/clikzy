...
export const metadata: Metadata = {
  ...
  description: "Besoin d'aide sur Cleekzy ? Contacte notre support (réponse ~2h) et consulte les questions fréquentes sur les livraisons, crédits et comptes.",
    ...
    <div className="min-h-dvh w-full relative overflow-y-auto bg-bg-primary">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
          {/* Contact Form (seule partie interactive — client component) */}
